...
const pool = mysql.createPool({
	host: process.env.MYSQL_HOST, //public_ip_sql_instance_Anda
	user: process.env.MYSQL_USER,
	password: process.env.MYSQL_PASS, //nama_database_Anda
	database: process.env.MYSQL_DATABASE, //password_sql_Anda
}).promise();
